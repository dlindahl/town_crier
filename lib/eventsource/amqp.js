...
function queueBind(stack) {
  ...
  queue.subscribe(function(message, headers, deliveryInfo) {
    client.onMessage.call(client, message, headers, deliveryInfo, routingKey);
  }).addCallback(function(queueSubscription) {
    stack.queueSubscription = queueSubscription;
    self.emit('queueBind', self, fanout, client);
    client.onSubscribe.call(client, stack);
